...
App.prototype._setDomElements = function () {
    ...
    this.domElements.metrics.bwTag = document.getElementById('bw-tag');
...
App.prototype._applyParameters = function () {
    ...
    this.player.addABRCustomRule('qualitySwitchRules', 'LowestBitrateRule', RMPCRule);
}
...
App.prototype._startIntervalHandler = function () {
    ...
    setInterval(function () {
        if (self.player && self.player.isReady()) {
            ...
            var availibleBW = Math.round(self.player.getAverageThroughput('video'));
            
            self.domElements.metrics.bwTag.innerHTML = availibleBW + ' kbps';
