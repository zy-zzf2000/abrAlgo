...
VIDEO_BIT_RATE = [200,600,1000]  # Kbps
BITRATE_REWARD = [1, 2, 3.3]
BITRATE_REWARD_MAP = {0: 0, 200: 1, 600: 2, 1000: 3.3}
M_IN_K = 1000.0
BUFFER_NORM_FACTOR = 10.0
CHUNK_TIL_VIDEO_END_CAP = 180
TOTAL_VIDEO_CHUNKS = 10000
    ...
    class Request_Handler(BaseHTTPRequestHandler):
        ...
        def do_POST(self):
            ...
            if ( 'pastThroughput' in post_data ):
                ...
                video_chunk_fetch_time = post_data['lastFragmentDownloadTime']
                #TODO: video fetch time的单位是毫秒
                ...
                with open('logfile.txt', 'w') as self.log_file:
